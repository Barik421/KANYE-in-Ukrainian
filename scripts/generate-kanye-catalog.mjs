...
const albums = [
  {
    ...
    featuredTracks: ['Jesus Walks', 'All Falls Down', 'Through the Wire'],
  },
  {
    ...
    featuredTracks: ['Gold Digger', 'Touch the Sky'],
  },
  {
    title: 'Graduation',
    year: 2007,
    ...
    featuredTracks: ['Stronger', 'Flashing Lights'],
  },
  {
  ...
  },
  {
    ...
    featuredTracks: ['Power', 'Runaway', 'All of the Lights'],
  },
  {
    title: 'Yeezus',
    year: 2013,
  ...
  },
  {
    ...
    featuredTracks: ['Father Stretch My Hands Pt. 1', 'Ultralight Beam'],
  },
  {
    title: 'ye',
    year: 2018,
